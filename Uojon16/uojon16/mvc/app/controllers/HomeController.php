		...
		if ( ! empty( $_POST ) ) 
{
	if ( isset( $_POST['username'] ) && isset( $_POST['password'] ) ) 
	{
		...
		if ( $_POST['password'] == $tempPw ) 
		{
			...
			$_SESSION['timeout'] = time();
			 header("Location: /uojon16/mvc/public/user/");
			 
		}
		else 
		{
			session_destroy();
			header("Location: /uojon16/mvc/public/signup/");
	...
	{ 
	(new User)-> createUser();
		$this->view('home/registering');
}	
	}
	public function logout() {
			session_unset();
			header('Location: /uojon16/mvc/public/home/login');
		} 
