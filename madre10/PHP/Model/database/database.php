...
function loadUserImages($conn, $userId) {
...
function loadNewImages($conn,$number_of_items){
...
function loadImageComments($conn, $imageId) {
...
function putComment($conn, $userId, $image_id, $comment){
