...
<head>
    <meta charset="UTF-8">
    <title>Login</title>
    <link href="/mmare15/mvc/public/css/style.css" type="text/css" rel="stylesheet">
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.css">
    <style type="text/css">

        /*** Cant seem to get the background image**/
        body{ font: 14px sans-serif; background-image: url("../resources/9.jpg")}
