...
class CommentRepository
{
    ...
    {
        return $this->conn->query_single_row("select comment_id, text, user_id, feed_entry_id from comments where comment_id = ?", CommentDatabaseEntry::class, "i", $comment_id);
    }
    ...
    public function add_comment(int $user_id, string $text, int $feed_entry_id): CommentDatabaseEntry
    {
        ...
        $this->conn->execute_prepared_query("insert into comments(text, user_id, feed_entry_id) values(?, ?, ?)", "sii", $text, $user_id, $feed_entry_id);
    ...
    {
        return $this->conn->query_multiple_rows("select comment_id, text, user_id, feed_entry_id from comments where feed_entry_id = ?", CommentDatabaseEntry::class, "i", $feed_entry_id);
    }
}