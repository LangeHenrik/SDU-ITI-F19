...
<html>    
	<head>        
		<title>HCHB's Exercise</title>
			...
			<script src="/heboe17/mvc/public/js/RegisterUser.js"></script>
	...
	<body>
		...
		<div class='main'>
			...
			<div class="content">
				<form action="/heboe17/mvc/public/Register/register" method="POST" onsubmit="return checkFields()" enctype='multipart/form-data'>
