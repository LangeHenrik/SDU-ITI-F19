...
<?php if (isloggedIn()) { ?>
    ...
    <b>Welcome <?php echo $viewbag['user']['firstName']?> </b>

    <form action="/Miho16/mvc/public/home/upload" enctype="multipart/form-data" id="fileForm" method="post">
    ...
    <form action="/Miho16/mvc/public/home/gallery" id="gallery" method="post">
        <input id="seeGalleryButton" name="seeGallery" type="submit" value="See gallery"><br><br>
    </form>



    <form action="/Miho16/mvc/public/home/users" id="usersForm" method="post">
    ...
    ?>
    <form action="/Miho16/mvc/public/home/logout" id="loginForm" method="post">
...
<?php }else { ?>
    ...
    <form action="/Miho16/mvc/public/home/login" id="loginForm" method="post" onsubmit="return checkForm(this);">
    ...
    <br><br>
    <form action="/Miho16/mvc/public/home/register" id="registerForm" method="post">
