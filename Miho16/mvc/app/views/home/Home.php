...
<head>
    ...
    <script src = "/Miho16/mvc/public/change_tabs.js"></script>
</head>
<body>
...
<div id="PostPage" class="tabcontent">
    <form action="/Miho16/mvc/public/home/post_picture" method="post" enctype="multipart/form-data">
    ...
    <br>
    <form action= "/Miho16/mvc/public/home/log_out" method="post">
