...
<body>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="upload.php" id="upload" method="post" enctype="multipart/form-data">
					</br><textarea name="img_title" rows="2" cols="41" placeholder="Give your image a title.."></textarea></br>
					<textarea name="img_desc" rows="4" cols="41" placeholder="Give your image a description.."></textarea></br></br>
	...
	<div class="flex-container">
		...
		if(isset($_SESSION['user'])){
			$sql = "SELECT * FROM images ORDER BY img_id DESC LIMIT 20;";
		...
		if($images !== null){
			foreach($images as $img){?>
					...
					<figure id="Test">
						...
						?>
						<br><br><b><figcaption><?php echo $username['username'];?></figcaption></b><br>
