...
<div class="wrapper">
    ...
    <form onsubmit="loginCheck()" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
        ...
        <div class="form-group">
            <input type="submit" id='submit' class="btn btn-primary" value="Login" ><label id='loginlabel'> </label>
        </div>
