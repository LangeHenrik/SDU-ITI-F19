...
<!-- action = "includes/register.inc.php" -->
    <main>
        ...
        <div class="container">
            ...
            <input type="text" placeholder="Enter Zipcode" id="zip">
            ...
            <input type="text" placeholder="Enter Phonenumber" id="phone_number">
            
            
            <button type="register-submit">Register here!</button>
...
function validateForm() {
  ...
  var phone_number = document.getElementById("phone_number").value;     
   ...
   var user_name_test = user_regex.test(user_name);
    ...
    //Phone number - with a Regex object that states that the phone number should be written in the following format; +45 XXXX XXXX.
    var phone_number_regex = /\+45 [\d]{4} [\d]{4}$/;
    ...
    if(!phone_number_test){
        ...
        document.getElementById("errors").innerHTML = "Please write a phone number in the following format +45 XXXX XXXX";
        return false;
    }
